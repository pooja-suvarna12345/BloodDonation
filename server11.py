...
@app.route('/')
def hel():
    conn = sqlite3.connect('C:\\xamp1\\htdocs\\Blood-Bank-master\\database123.db')
...
def addrec():
   ...
   if request.method == 'POST':
      try:
         ...
         with sqlite3.connect("C:\\xamp1\\htdocs\\Blood-Bank-master\\database123.db") as con:
             cur = con.cursor()
...
def index():
    ...
    if request.method == 'POST':
        ...
        print(type)
        if type=='blood':
            con = sqlite3.connect('C:\\xamp1\\htdocs\\Blood-Bank-master\\database123.db')
